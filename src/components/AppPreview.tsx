...
const AppPreview: React.FC = () => {
  return (
    <section id="coverage" className="py-20 bg-[#1E293B] text-white">
        ...
        <div className="grid gap-8 lg:grid-cols-2 items-center">
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[28px] bg-[#111827]/90 p-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative rounded-[40px] border border-[rgba(255,255,255,0.12)] bg-[#0F172A]/70 p-6 shadow-glow"
          >
            <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[#F97316]/15 to-transparent" />
            <div className="relative rounded-[32px] bg-[#111827]/95 p-6">
              ...
              <div className="h-[360px] rounded-[28px] border border-[#FFFFFF]/10 bg-[#0F172A] p-6">
                <img
                  src={mapPreview}
                  alt="Map preview"
              ...
              <div className="mt-6 grid gap-4">
                <div className="rounded-3xl bg-[#0F172A]/80 p-4">
